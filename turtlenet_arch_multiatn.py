...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1024, zero_init_residual=False,
        ...
        self.attn1 = SelfAttnLayer.AttentionConv(64, 64, kernel_size=5, padding=2)
        self.attn2 = SelfAttnLayer.AttentionConv(128, 128, kernel_size=3, padding=1)
        self.attn3 = SelfAttnLayer.AttentionConv(256,256,kernel_size=3,padding=1)
